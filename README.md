...
Если ваше устройство это смартфон (на Android потому что на iOS проблемы с термуксом) вам нужен этот самый термукс для установки и дальнейших шагов. Безопасно скачивайте приложение Termux на F-Droid.
